...
@interface BookPageLoading ()<CAAnimationDelegate>

@property(strong, nonatomic) NSMutableArray *layersArr;
...
@implementation BookPageLoading
...
- (void)configBaseView {
    ...
    _timer = [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(configLayer) userInfo:nil repeats:YES];
    [_timer fire];
}
